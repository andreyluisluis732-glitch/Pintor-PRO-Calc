...
import { ArrowLeft, Search, Tag, Ruler, Info, Palette, Layers } from 'lucide-react';
...
export default function CatalogPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f9f9fd] text-[#191c1e] pb-32">
      <header className="w-full top-0 sticky bg-[#f9f9fd] z-40 border-b border-outline-variant/10">
        <div className="flex items-center justify-between px-6 py-4 w-full max-w-md mx-auto">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-[#002D5E]">Catálogo de Tintas</h1>
          </div>
        </div>
      </header>
          ...
          {filteredProducts.length === 0 ? (
            ...
            filteredProducts.map((product, idx) => (
              ...
              >
                ...
                <button 
                  onClick={() => router.push(`/calculate?productId=${product.id}`)}
